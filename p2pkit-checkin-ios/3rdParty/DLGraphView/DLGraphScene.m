...
- (void)updateEdge:(DLEdge *)edge {
    ...
    connection.strokeColor = (edge.immediateConnection ? [SKColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:100.0/255.0 alpha:1.0] : [SKColor lightGrayColor]);
}
...
- (void)removeEdge:(DLEdge *)edge {
    ...
    if (vertex) {
        SKAction *zoom = [SKAction fadeOutWithDuration:0.25];
        [vertex runAction:zoom completion:^{
...
- (void)createConnectionForEdge:(DLEdge *)edge {
    ...
    connection.strokeColor = (edge.immediateConnection ? [SKColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:100.0/255.0 alpha:1.0] : [SKColor lightGrayColor]);
    connection.fillColor = [SKColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:100.0/255.0 alpha:1.0];
